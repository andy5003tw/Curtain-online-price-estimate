...
const PRICE_GUIDE_SNIPPET_VARIANTS = {
  A: {
    title: '窗簾價格多少合理？2026 窗簾價格、窗簾安裝費用與試算',
    description:
      '想知道窗簾價格多少合理、窗簾價格與窗簾安裝費用怎麼看？先看 2026 行情、合理價格與試算差異，再用窗簾計算機估價。',
  },
  B: {
    title: '2026 窗簾價格指南｜窗簾價格多少合理與安裝費用',
    description:
      '先看窗簾價格多少合理、窗簾價格、百葉窗價格試算與窗簾安裝費用差異，再進線上估價比較捲簾、紗簾、實木百葉與訂製窗簾。',
  },
} as const;
