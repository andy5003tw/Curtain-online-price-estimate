...
const PRICE_GUIDE_SNIPPET_VARIANTS = {
  A: {
    ...
    description:
      '想查窗簾價格、窗簾價格試算、百葉窗價格試算或訂製窗簾報價？先看 2026 行情、價格比較表與安裝費，再用窗簾計算機輸入尺寸快速估價。',
  },
  B: {
    title: '2026 窗簾價格試算指南｜百葉窗價格試算、安裝費與訂製窗簾報價',
    description:
      '先看窗簾價格區間、百葉窗價格試算與窗簾安裝費差異，再進線上估價工具，比較捲簾、鋁百葉、無縫紗簾、實木百葉與訂製窗簾預算。',
  },
} as const;
