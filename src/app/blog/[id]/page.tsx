...
const PRICE_GUIDE_SNIPPET_VARIANTS = {
  A: {
    title: '2026 窗簾價格指南｜合理價格、價格試算與安裝費',
    description:
      '想知道窗簾價格多少合理？先看 2026 行情、百葉窗價格試算、安裝費與訂製窗簾報價，再用窗簾計算機估價。',
  },
  B: {
    title: '2026 窗簾價格試算指南｜合理價格、百葉窗與安裝費',
    description:
      '先看窗簾合理價格、百葉窗價格試算與窗簾安裝費差異，再進線上估價工具，比較捲簾、無縫紗簾、實木百葉與訂製窗簾預算。',
  },
} as const;
