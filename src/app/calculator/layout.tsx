...
const CALCULATOR_SNIPPET_VARIANTS = {
  A: {
    title: '窗簾價格試算｜窗簾線上估價、1分鐘比較安裝費',
    description:
      '1 分鐘完成窗簾價格試算與窗簾線上估價，含基本安裝費，可用同尺寸比較百葉窗價格試算、實木百葉、捲簾與調光簾。',
  },
  B: {
    title: '窗簾線上估價｜窗簾價格試算、窗簾計算機與安裝費',
    description:
      '快速完成窗簾線上估價與窗簾價格試算，支援百葉窗價格試算、實木百葉窗價格試算、捲簾與調光簾比價，先抓合理預算再丈量。',
  },
} as const;
