...
const productDetails: Record<string, { features: string[]; useCases: string[]; fullDesc: string }> = {
  ...
  P002: {
    ...
    useCases: ['客廳', '餐廳', '書房'],
    fullDesc: '紗簾價格與無縫紗簾推薦怎麼看最快？建議先固定同一尺寸，比較透光不透人紗簾效果、雙層窗簾搭配、軌道與安裝費，再安排台北、士林或中正區到府丈量確認正式報價。無縫紗簾適合想兼顧採光、隱私與空間通透感的人，透過整幅布料減少接縫干擾，白天能柔化採光、保留隱私，夜晚再搭配遮光布簾補足遮蔽效果，特別適合客廳、書房與落地窗場景先比較風格與預算。',
  },
  P003: {
  ...
  P007: {
    ...
    useCases: ['客廳', '書房', '餐廳'],
    fullDesc: '實木百葉窗價格試算怎麼判斷合理？先看窗戶尺寸、木種、葉片寬度、表面塗裝、窗型與安裝高度。建議先做同尺寸試算，快速比較木百葉窗簾價格、客廳落地窗木百葉方案、台北與板橋常見安裝費，再搭配中正區書房或景觀窗情境評估木質感與正式報價。',
  },
  P008: {
...
const productSeoExtras: Record<string, {
  ...
  P002: {
    ...
    lsiParagraph: '無縫紗簾是近年來很受歡迎的透光不透人窗簾款式，尤其適合想保留自然光、又不希望白天室內被一眼看穿的家庭。若你正在比較紗簾價格、透光不透人紗簾、紗簾推薦、雙層窗簾搭配或客廳紗簾價格，重點不只在布料本身，也包含軌道長度、垂墜高度、是否搭配遮光布簾與現場安裝條件。建議先確認想要的採光感，再做無縫紗簾價格試算，整體報價會更接近實際需求。',
