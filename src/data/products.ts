export const products = [
  {
    ...
    "description": "窗簾訂製價格依尺寸、布料、遮光等級與安裝條件估算；先輸入尺寸比較做窗簾價格、訂製窗簾價格、遮光窗簾與布簾訂製，再安排丈量確認客廳布簾等訂製需求的正式報價。",
    "seo": {
      "meta_title": "窗簾訂製價格｜做窗簾價格、布簾與遮光線上估算",
      "meta_description": "窗簾訂製價格依尺寸、布料與遮光等級估算；比較做窗簾價格、訂製窗簾價格、窗簾訂做價格、遮光窗簾、布簾訂製與客廳布簾，立即輸入尺寸試算並預約丈量確認報價。",
      "keywords": ["窗簾訂製價格", "做窗簾價格", "訂製窗簾價格", "窗簾訂做價格", "遮光窗簾", "布簾訂製", "客廳布簾"]
    }
  },
  {
    "id": "P002",
    ...
    "description": "紗簾價格可先用同尺寸試算透光不透人無縫紗簾、雙層窗簾、軌道與基本安裝費；送出需求後安排台北到府看樣與丈量確認正式報價。",
    "seo": {
      "meta_title": "紗簾價格試算｜無縫透光不透人紗簾、雙層搭配與到府丈量",
      "meta_description": "想查紗簾價格？先用同尺寸試算無縫透光不透人紗簾、雙層搭配、軌道與基本安裝費；立即送出需求安排台北到府看樣丈量。",
  ...
  },
  {
    ...
    "description": "百葉窗價格試算可先以同尺寸比較鋁百葉的葉片寬度、防潮需求、窗型與基本安裝費；立即線上估價後，再安排到府丈量確認鋁百葉窗價格。",
    "seo": { "meta_title": "百葉窗價格試算｜鋁百葉防潮材質、安裝費與線上估價", "meta_description": "想查百葉窗簾價格或鋁百葉窗價格？先用同尺寸試算葉片寬度、防潮材質、窗型與基本安裝費；適合浴室、廚房與商辦小窗，立即安排丈量。", "keywords": ["百葉窗價格試算", "百葉窗價格", "百葉窗簾價格", "鋁百葉窗價格", "鋁百葉窗價格試算", "台北鋁百葉窗價格", "三重鋁百葉窗價格", "新莊鋁百葉窗價格", "鋁百葉窗簾訂製", "百葉窗安裝費"] }
  },
  {
    "id": "P007",
    "legacyId": "P007",
    ...
    "description": "實木百葉窗價格試算先固定同一尺寸，比較木種、葉片寬度、窗型與基本安裝費；適合客廳與書房的乾燥空間，再由到府丈量確認正式報價。",
    "seo": { "meta_title": "實木百葉窗價格試算｜木百葉窗簾價格、客廳書房線上估價", "meta_description": "實木百葉窗價格試算先輸入尺寸，比較木種、葉片寬度、窗型與安裝費；立即查木百葉窗簾價格，再預約丈量確認正式報價。適合客廳與書房等乾燥空間。", "keywords": ["木百葉窗價格", "木百葉簾價錢", "台北實木百葉窗價格", "三重實木百葉窗價格", "板橋實木百葉窗價格", "實木百葉窗價格試算", "木百葉窗簾價格", "木百葉窗簾訂製", "實木百葉窗安裝費", "客廳木百葉"] }
  },
  {
    "id": "P008",
    "legacyId": "P008",
