export const products = [
  ...
  },
  {
    ...
    "description": "紗簾價格可先用同尺寸比較透光不透人紗簾、無縫紗簾、雙層窗簾搭配與安裝費，再安排台北、中正區或士林到府丈量確認正式報價。",
    "seo": {
      "meta_title": "紗簾價格｜透光不透人紗簾、無縫紗簾與安裝費",
      "meta_description": "想查紗簾價格或透光不透人紗簾？先比較無縫紗簾、客廳採光、雙層窗簾與安裝費，再安排台北到府看樣。",
  ...
  },
  {
    ...
    "description": "實木百葉窗價格試算適合先比較木種、葉片寬度、客廳木質感與基本安裝費，再對照台北、板橋與中正區丈量流程，確認木百葉窗簾價格是否合理。",
    "seo": { "meta_title": "實木百葉窗價格試算｜木百葉窗簾價格、材質與安裝費", "meta_description": "想查實木百葉窗價格試算或木百葉窗簾價格？先看木種、葉片寬度、客廳搭配、基本安裝費與窗型條件，再安排到府丈量。", "keywords": ["台北實木百葉窗價格", "三重實木百葉窗價格", "板橋實木百葉窗價格", "實木百葉窗價格試算", "木百葉窗簾價格", "木百葉窗簾訂製", "實木百葉窗安裝費", "客廳木百葉"] }
  },
  {
    "id": "P008",
    "legacyId": "P008",
