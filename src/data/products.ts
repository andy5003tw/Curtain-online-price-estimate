export const products = [
  ...
  },
  {
    ...
    "seo": { "meta_title": "台北實木百葉窗價格、三重實木百葉窗價格｜實木百葉窗價格試算", "meta_description": "查看台北與三重實木百葉窗價格區間，支援窗簾線上估價與實木百葉窗價格試算，快速完成木百葉窗簾訂製評估。", "keywords": ["台北實木百葉窗價格", "三重實木百葉窗價格", "實木百葉窗價格試算", "木百葉窗簾訂製"] }
  },
  {
    "id": "P008",
    "legacyId": "P008",
