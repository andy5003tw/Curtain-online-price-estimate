export const products = [
  {
    ...
    "description": "做窗簾價格可先輸入窗戶尺寸，比較布料、遮光等級、軌道與基本安裝費；再安排到府丈量確認訂製窗簾正式報價。",
    "seo": {
      "meta_title": "做窗簾價格試算｜訂製布簾、遮光與安裝費",
      "meta_description": "做窗簾價格怎麼算？輸入尺寸即可先比較訂製布簾、遮光等級、雙層搭配、軌道與基本安裝費，再安排到府丈量確認報價。",
  ...
  },
  {
    ...
    "seo": { "meta_title": "實木百葉窗價格試算｜木百葉、客廳書房與安裝費", "meta_description": "實木百葉窗價格怎麼算？先用同一尺寸試算木種、葉片寬度、窗型與基本安裝費；適合客廳、書房等乾燥空間，再安排到府丈量確認報價。", "keywords": ["木百葉窗價格", "木百葉簾價錢", "台北實木百葉窗價格", "三重實木百葉窗價格", "板橋實木百葉窗價格", "實木百葉窗價格試算", "木百葉窗簾價格", "木百葉窗簾訂製", "實木百葉窗安裝費", "客廳木百葉"] }
  },
  {
    "id": "P008",
    "legacyId": "P008",
