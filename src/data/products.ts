export const products = [
  ...
  },
  {
    ...
    "primaryKeyword": "無縫紗簾推薦",
    "secondaryKeywords": ["紗簾價格", "透光不透人紗簾", "紗簾訂製", "透光不透人窗簾", "雙層窗簾", "台北紗簾"],
    ...
    "description": "無縫紗簾推薦與紗簾價格可先用同尺寸比較透光不透人紗簾、雙層窗簾搭配與安裝費，再安排台北、中正區或士林到府丈量確認正式報價。",
    "seo": {
      "meta_title": "紗簾價格與無縫紗簾推薦｜透光不透人紗簾、雙層窗簾",
      "meta_description": "想查紗簾價格、透光不透人紗簾或無縫紗簾推薦？先比較客廳採光、雙層窗簾、安裝費與台北丈量流程，再安排到府看樣。",
  ...
  },
  {
    ...
    "description": "實木百葉窗價格試算適合先比較木種、葉片寬度、客廳木質感與安裝費，再對照台北、板橋與中正區丈量流程，確認木百葉窗簾價格是否合理。",
    "seo": { "meta_title": "實木百葉窗價格試算｜木百葉窗簾價格、客廳搭配與安裝費", "meta_description": "想查實木百葉窗價格試算或木百葉窗簾價格？先看木種、葉片寬度、客廳搭配、安裝費與窗型條件，再安排到府丈量。", "keywords": ["台北實木百葉窗價格", "三重實木百葉窗價格", "板橋實木百葉窗價格", "實木百葉窗價格試算", "木百葉窗簾價格", "木百葉窗簾訂製", "實木百葉窗安裝費", "客廳木百葉"] }
  },
  {
    "id": "P008",
    "legacyId": "P008",
