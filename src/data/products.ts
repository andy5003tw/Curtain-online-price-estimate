export const products = [
  {
    ...
    "secondaryKeywords": ["做窗簾價格", "訂製窗簾價格", "窗簾訂做價格", "遮光窗簾", "布簾訂製", "客廳布簾", "台北窗簾"],
    ...
    "description": "窗簾訂製價格可先用同尺寸比較做窗簾價格、訂製窗簾價格、遮光布簾、雙層搭配、軌道與基本安裝費，再安排到府丈量確認正式報價。",
    "seo": {
      "meta_title": "窗簾訂製價格｜做窗簾價格、訂製窗簾價格與安裝費",
      "meta_description": "想查窗簾訂製價格、做窗簾價格或訂製窗簾價格？先比較布料、雙層搭配、軌道與基本安裝費，再線上估價安排丈量。",
      "keywords": ["窗簾訂製價格", "做窗簾價格", "訂製窗簾價格", "窗簾訂做價格", "窗簾訂製", "遮光窗簾", "遮光布簾", "客廳布簾", "窗簾價格試算"]
    }
  },
  {
    "id": "P002",
    ...
    "description": "紗簾價格先用同尺寸比較透光不透人紗簾、無縫紗簾、雙層窗簾搭配、軌道與基本安裝費，再安排台北、中正區或士林到府丈量確認正式報價。",
    "seo": {
      "meta_title": "紗簾價格｜透光不透人紗簾、無縫紗簾與安裝費",
      "meta_description": "想查紗簾價格或透光不透人紗簾？先比較無縫紗簾、客廳採光、雙層窗簾、軌道與基本安裝費，再安排台北到府看樣。",
  ...
  },
  {
    ...
    "description": "百葉窗價格試算適合先用同尺寸比較百葉窗簾價格、鋁百葉窗價格、葉片寬度、防潮耐用度與基本安裝費，再安排到府丈量。",
    "seo": { "meta_title": "百葉窗價格試算｜百葉窗簾價格、鋁百葉窗價格與安裝費", "meta_description": "想查百葉窗價格試算或百葉窗簾價格？先比較鋁百葉窗價格、葉片寬度、防潮耐用度與基本安裝費，再同尺寸線上估價。", "keywords": ["百葉窗價格試算", "百葉窗簾價格", "鋁百葉窗價格", "百葉窗價格", "台北鋁百葉窗價格", "三重鋁百葉窗價格", "新莊鋁百葉窗價格", "鋁百葉窗簾訂製", "百葉窗安裝費"] }
  },
  {
    "id": "P007",
    "legacyId": "P007",
    ...
    "secondaryKeywords": ["木百葉窗簾價格", "台北實木百葉窗價格", "三重實木百葉窗價格", "實木百葉窗價格試算", "木百葉窗簾訂製", "書房窗簾"],
    "updatedAt": "2026-06-24",
    "name": "木百葉窗簾",
    ...
    "description": "實木百葉窗價格試算適合先比較木種、葉片寬度、客廳木質感、窗型條件與基本安裝費，再對照台北、板橋與中正區丈量流程，確認木百葉窗簾價格是否合理。",
    "seo": { "meta_title": "實木百葉窗價格試算｜木百葉窗簾價格、材質與安裝費", "meta_description": "想查實木百葉窗價格試算或木百葉窗簾價格？先看木種、葉片寬度、客廳搭配、窗型條件與基本安裝費，再安排到府丈量。", "keywords": ["台北實木百葉窗價格", "三重實木百葉窗價格", "板橋實木百葉窗價格", "實木百葉窗價格試算", "木百葉窗簾價格", "木百葉窗簾訂製", "實木百葉窗安裝費", "客廳木百葉"] }
  },
  {
    "id": "P008",
    "legacyId": "P008",
